...
class BackgroundImageTextModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      width: null,
      ...
      <View style={styles.containerContentStyle}>
        ...
        <ScrollView contentContainerStyle={{
          ...
          <View style={{
            ...
            <View style={Object.assign({}, styles.overlayStyle, {
              zIndex: -1,
              backgroundColor: filterOpacityColor[0].Default,
              opacity: opacityValue,
              height: '100%',
            })} />
            <View style={{ paddingBottom: helpers.headerForIphoneX ? 20 : null, paddingLeft: 6, paddinRight: 6 }}>
              <DxHtmlReader5
...
BackgroundImageTextModal.propTypes = {
  closeModal: PropTypes.func,
};

export default BackgroundImageTextModal;
