...
class DxLink extends Component {
  ...
  handleOpenPopup = () => {
    this.props.openModal('WEB', this.props.targetSectionGUID);
  }
      ...
      <React.Fragment>
        {
          currentTab === 'Bookmark' ? <TouchableOpacity style={{
            backgroundColor: linkBgColor || '#fff', flex: 1, paddingTop: 20, paddingBottom: 20, paddingLeft: 6, paddingRight: 6,
          }} onPress={() => this.handleOpenPopup()}>
            <DxHtmlReader3
              source={linkLabel || link} contentWidth={contentWidth}
              searchValue={this.props.searchValue}
            />
          </TouchableOpacity> : <TouchableOpacity style={{ backgroundColor: linkBgColor || '#fff' }} onPress={() => this.handleOpenPopup()}>
